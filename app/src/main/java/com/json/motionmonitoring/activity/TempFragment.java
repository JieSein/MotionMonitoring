...
public class TempFragment extends Fragment {
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what) {
                ...
                case 1:
                    ...
                    break;
                case 2 :
                    double data = msg.getData().getDouble("data");
                    temp_data.setText(data+"");
                    if (data != 0){
                        temp_data.startAnimation(mScaleAnimation);
                    }
                    break;
            }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_temp, container, false);
    ...
    private void initView(View view){
        temp_data = (TextView)view.findViewById(R.id.temp_data);
    ...
    private void displayData(final String rev_string){
        ...
        if (flag == 1){
            ...
            tempData = Double.parseDouble(rev_data.substring(8,12));
            Log.d(TAG, "temp_data: "+tempData);
        }
        Log.d(TAG, "flag: "+flag);
