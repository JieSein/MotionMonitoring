...
import com.json.motionmonitoring.view.HeartWireView;
...
public class HeartFragment extends Fragment {
    ...
    private HeartWireView mHeartWireView;
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    heart_data.setText(data + "");
                    if (data != 0){
                        img_heart.startAnimation(mScaleAnimation);
                    }
                    break;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_heart, container, false);
    ...
    private void init_view(View view){
        heart_data = (TextView)view.findViewById(R.id.heart_data);
        img_heart = (ImageView)view.findViewById(R.id.img_heart);
        mHeartWireView = (HeartWireView)view.findViewById(R.id.heart_wire);
    ...
    private void displayData(final String rev_string){
        ...
        if (flag == 1){
            ...
            heartdata = Integer.parseInt(rev_data.substring(5,8));
            Log.d(TAG, "heart_data: "+heartdata);
        }
        Log.d(TAG, "flag: "+flag);
